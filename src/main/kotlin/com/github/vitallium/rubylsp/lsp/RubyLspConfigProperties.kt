...
class RubyLspConfigProperties(private val propertiesComponent: PropertiesComponent) {
    ...
    companion object {
        private val PLUGIN_ENABLED_KEY = RubyLspConfigProperties::class.java.getPackageName() + ".enabled"
        private val EXPERIMENTS_ENABLED_KEY = RubyLspConfigProperties::class.java.getPackageName() + ".enableExperiments"
        private val FORMATTING_ENABLED_KEY = RubyLspConfigProperties::class.java.getPackageName() + ".enableFormatting"
    }
}
